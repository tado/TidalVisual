...
void StSyncopationMonitorColor::setup() {
	name = "StSyncopationMonitorColor";
...
void StSyncopationMonitorColor::update() {
	width = ofGetWidth() - (left * 2);
	height = ofGetHeight() / 2 - (top * 2);
}
...
void StSyncopationMonitorColor::drawGrid() {
	ofDisableSmoothing();
...
void StSyncopationMonitorColor::stateExit() {

}

void StSyncopationMonitorColor::stateEnter() {

}

string StSyncopationMonitorColor::getName() {
	return name;
}
